        ...
        <div class="row clearfix">
            <div class="row row-cols-3" style="">
                @foreach ($blogs as $key => $blog)
                        ...
                        <div class="body">
                            <div class="img-post">
                                <img class="d-block img-fluid" style=" " src="{{ url('uploads/blog/'.$blog->image) }}" alt="First slide">
                            </div>
                            <h3><a href="{{ url('blog/'.$blog->IDblog) }}">{{ $blog->title }}</a></h3>
                            <p></p>
                        </div>
                        <div class="footer">
                            <div class="actions">
                                <a href="{{ url('blog/'.$blog->IDblog) }}" class="btn btn-warning btn-info ">Continue Reading</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                ...
                {{-- <div class="cardblog single_post">
                    <div class="body">
                        <div class="img-post">
